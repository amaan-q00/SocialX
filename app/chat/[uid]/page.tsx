...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-zinc-900 text-white safe-area relative">
      {/* Header */}
          ...
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-44 bg-zinc-800 rounded-md shadow-lg z-50">
              <button
                ...
                className="w-full text-left px-4 py-2 hover:bg-red-600 text-red-500"
              >
                Remove Friend
              </button>
              <button
  ...
  className="flex-1 overflow-y-auto p-4 flex flex-col space-y-2 space-y-reverse pb-[env(safe-area-inset-bottom)]"
>
              ...
              <div
                className={`px-4 py-2 rounded-2xl break-words ${
                  isMe
                    ...
                    : "bg-accent text-black rounded-bl-sm"
                }`}
              >
      ...
      {/* Input */}
      <div className="sticky bottom-0 p-3 border-t border-zinc-700 flex items-center gap-2 bg-zinc-900 safe-area-bottom chat-input-container">
        <input
          type="text"
          value={input}
          ...
          className="flex-1 bg-zinc-800 px-4 py-2 rounded-full text-white placeholder:text-zinc-500 min-w-0" // Added min-w-0
        />
        <button
          onClick={handleSend}
          disabled={sending}
          className="flex-shrink-0 pr-1" // Added pr-1
        >
          {sending ? (
      ...
      {showProfile && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 safe-area">
          <div
            ref={modalRef}
            className="bg-zinc-800 p-4 rounded-xl w-full max-w-md relative"
          >
            {otherUser ? (
              <>
                {otherUser.profilePic ? (
            ...
            <button
              ...
              className="absolute top-3 right-3 p-1 hover:bg-zinc-700 rounded-full"
            >
